/* Module-------->In JavaScript, when using modules, you can export functions, objects, or values from one module to be imported into another module. There are two types of exports: default exports and named exports.1) import and Export2) Export    --> Named Export    --> Default Export    1) Named Export A named export allows you to export multiple values from a single module by explicitly specifying their names.  syntax:    export:export function add(a, b) {    return a + b;}export const PI = 3.14159;import:import { add, PI } from './module.js';console.log(add(2, 3)); // Output: 5console.log(PI); // Output: 3.14159    2) Default ExportDefault Export: The default export is used to export a single value from a module. Unlike named exports, there can only be one default export per module. It is marked with the export default syntax.  default export are used to export single value like array, abject, function etc
...
console.log(data1('aswin'));

// alliesName:

import {Name, Address} from './module.js';

...
person2.name = 'kumar'; // here we have changed value of person2 however person1's value is changed now
...
/*
  in above example person1 and person was pointing or referencing to the same memory block in Heap and that is why both value changed
  however if person2 = {whole different object} and not changing properties only then it will create whole new block in memory and 
